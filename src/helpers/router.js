...
import { HomeView, LoginView, Garden, GardensView, SetPassword, InstructionPublic, GardenApplyForm } from '@/views';
...
router.beforeEach(async (to) => {
    ...
    const publicPages = ['/login','/oauth/google/callback', '/set-password', '/apply'];
